...
SHOTS = [
    ('week',    '01-week',    'A week of lunches\nin about a minute.', 'A main, a side, a fruit and a sweet for every school day, matched so each box goes together.'),
    ...
    ('kidpick', '03-kidpick', 'Hand them the phone.\nThey pick.',       'Two pictures per compartment, all inside your rules. A lunch they chose comes home emptier.'),
