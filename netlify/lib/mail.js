...
/* the beta testers' private Facebook group: the quick stuff, screenshots, questions, what the kid did */
export const BETA_GROUP = 'https://fb.me/g/7QlD2hwuL/xxqnw6dQ';
export function sendWelcome(to, site, stopUrl, beta) {
  const app = `${site}/app/`;
  if (beta) return send({
    to,
    subject: 'You\u2019re in the beta. Lunch Sorted is yours, free forever.',
    text: `Thank you for beta testing Lunch Sorted.\n\nYou are signed in, and the moment the app opens, everything is on for your household, for good: every lunchbox, kid's pick, the morning review, a pantry that remembers, and the other parent's phone. No card, ever.\n\nOpen the planner: ${app}\n\nWorth doing this week: add it to your phone's home screen (on iPhone: Share, then Add to Home Screen), and invite the other parent from Account so you both see the same week.\n\nThree short emails in your first week say what to try and where to give feedback. Reply to any of them and I read it.\n\nPlease join the creator and other testers in our private Facebook group to join the conversation and share ideas, how you used it, what problems it solved or where you got stuck! Feedback is a gift! Thank you for your support!\n${BETA_GROUP}\n\nLiz` + foot(stopUrl).text,
    html: `<p>Thank you for beta testing Lunch Sorted.</p><p>You are signed in, and the moment the app opens, everything is on for your household, for good: every lunchbox, kid\u2019s pick, the morning review, a pantry that remembers, and the other parent\u2019s phone. No card, ever.</p>${btn(app, 'Open the planner')}<p>Worth doing this week: add it to your phone\u2019s home screen (on iPhone: Share, then <b>Add to Home Screen</b>), and invite the other parent from Account so you both see the same week.</p><p>Three short emails in your first week say what to try and where to give feedback. Reply to any of them and I read it.</p><p>Please join the creator and other testers in our <a href="${esc(BETA_GROUP)}">private Facebook group</a> to join the conversation and share ideas, how you used it, what problems it solved or where you got stuck! Feedback is a gift! Thank you for your support!</p><p>Liz</p>` + foot(stopUrl).html
  });
  return send({
    to,
    subject: 'You’re in. Everything is on for three weeks.',
    text: `Welcome to Lunch Sorted.\n\nYou are signed in. While your household's first three weeks run, everything is on: foods in your own words or brought in from a recipe page, every lunchbox, kid's pick, the morning review, a pantry that remembers, and the other parent's phone. No card, nothing to cancel.\n\nOpen the planner: ${app}\n\nWorth doing this week: add it to your phone's home screen (on iPhone: Share, then Add to Home Screen), and if you set the household up, invite the other parent from Account → Household so you both see the same week.\n\nAfter the three weeks, planning, the shopping list and the idea bank — recipes and all — stay free for good. The rest is the Household plan, when you want it; the prices are in the app.` + foot(stopUrl).text,
    html: `<p>Welcome to Lunch Sorted.</p><p>You are signed in. While your household’s first three weeks run, everything is on: foods in your own words or brought in from a recipe page, every lunchbox, kid’s pick, the morning review, a pantry that remembers, and the other parent’s phone. No card, nothing to cancel.</p>${btn(app, 'Open the planner')}<p>Worth doing this week: add it to your phone’s home screen (on iPhone: Share, then <b>Add to Home Screen</b>), and if you set the household up, invite the other parent from Account → Household so you both see the same week.</p><p>After the three weeks, planning, the shopping list and the idea bank — recipes and all — stay free for good. The rest is the Household plan, when you want it; the prices are in the app.</p>` + foot(stopUrl).html
  });
}
...
export function sendTrialEnded(to, site, stopUrl) {
  ...
  return send({
    ...
    text: `Your three weeks of everything on Lunch Sorted are up.\n\nPlanning the week, the shopping list and the idea bank — recipes and all — are still free, and everything you added is still there. Your own foods, kid's pick, the morning review and the pantry are waiting under the Household plan, along with adding lunchboxes and phones: $29 a year, $3.99 a month, or $79 once, forever.\n\nSwitch it back on: ${keep}\n\nThis is the last email about it.` + foot(stopUrl).text,
    html: `<p>Your three weeks of everything on Lunch Sorted are up.</p><p>Planning the week, the shopping list and the idea bank — recipes and all — are still free, and everything you added is still there. Your own foods, kid’s pick, the morning review and the pantry are waiting under the Household plan, along with adding lunchboxes and phones: $29 a year, $3.99 a month, or $79 once, forever.</p>${btn(keep, 'Switch it back on')}<p style="color:#6E7F75;font-size:13px">This is the last email about it.</p>` + foot(stopUrl).html
  });
}
...
export function sendTester(to, site, day, stopUrl) {
  ...
  const notes = {
    1: { subject: 'Thank you for beta testing Lunch Sorted',
         ...
         steps: ['Open the app and tap <b>Week</b>. If it is empty, tap <b>Shuffle all</b>. With more than one lunchbox it asks whose first, and each box has its own tab along the top.',
    ...
    6: { subject: 'Almost a week in. What came home?',
         ...
         steps: ['After your kid gets home, <b>Pack</b> asks how it went. Tap <b>Ate it</b>, <b>Some</b> or <b>Came home</b> for each compartment.',
                 ...
                 'While you are on <b>Foods</b>: <b>Add your own</b>, with what to buy for it, so the list carries your family\u2019s real food. New this week, beside it: <b>Import a recipe</b> \u2014 paste the address of a recipe page, or the words under a reel, and it lands as a food with the recipe attached.'],
         alt: 'What came home: ate it, some, or came home',
         ask: 'Recipes landed this week: most of the idea bank\u2019s cooked dishes carry one now, and Foods \u2192 Import a recipe brings in your own. Did you cook from it? Here is what I am planning next:<ul style="padding-left:22px">' + PLANNED.map(x => `<li style="margin:0 0 6px">${esc(x)}</li>`).join('') + '</ul>Would those help? What would you add? And would you keep using Lunch Sorted? Tell me why, either way.',
         askText: 'Recipes landed this week: most of the idea bank\u2019s cooked dishes carry one now, and Foods -> Import a recipe brings in your own. Did you cook from it?\n\nHere is what I am planning next:\n' + PLANNED.map(x => '- ' + x).join('\n') + '\n\nWould those help? What would you add? And would you keep using Lunch Sorted? Tell me why, either way.' }
  }[day];
