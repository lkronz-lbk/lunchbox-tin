...
export function sendWelcome(to, site, stopUrl, beta) {
  ...
  return send({
    ...
    text: `Welcome to Lunch Sorted.\n\nYou are signed in. While your household's first three weeks run, everything is on: foods in your own words, every lunchbox, kid's pick, the morning review, a pantry that remembers, and the other parent's phone. No card, nothing to cancel.\n\nOpen the planner: ${app}\n\nWorth doing this week: add it to your phone's home screen (on iPhone: Share, then Add to Home Screen), and if you set the household up, invite the other parent from Account → Household so you both see the same week.\n\nAfter the three weeks, planning, the shopping list and the idea bank stay free for good. The rest is the Household plan, when you want it; the prices are in the app.` + foot(stopUrl).text,
    html: `<p>Welcome to Lunch Sorted.</p><p>You are signed in. While your household’s first three weeks run, everything is on: foods in your own words, every lunchbox, kid’s pick, the morning review, a pantry that remembers, and the other parent’s phone. No card, nothing to cancel.</p>${btn(app, 'Open the planner')}<p>Worth doing this week: add it to your phone’s home screen (on iPhone: Share, then <b>Add to Home Screen</b>), and if you set the household up, invite the other parent from Account → Household so you both see the same week.</p><p>After the three weeks, planning, the shopping list and the idea bank stay free for good. The rest is the Household plan, when you want it; the prices are in the app.</p>` + foot(stopUrl).html
  });
}
...
export function sendTrialEnded(to, site, stopUrl) {
  ...
  return send({
    ...
    text: `Your three weeks of everything on Lunch Sorted are up.\n\nPlanning the week, the shopping list and the idea bank are still free, and everything you added is still there. Your own foods, kid's pick, the morning review and the pantry are waiting under the Household plan, along with adding lunchboxes and phones: $29 a year, $3.99 a month, or $79 once, forever.\n\nSwitch it back on: ${keep}\n\nThis is the last email about it.` + foot(stopUrl).text,
    html: `<p>Your three weeks of everything on Lunch Sorted are up.</p><p>Planning the week, the shopping list and the idea bank are still free, and everything you added is still there. Your own foods, kid’s pick, the morning review and the pantry are waiting under the Household plan, along with adding lunchboxes and phones: $29 a year, $3.99 a month, or $79 once, forever.</p>${btn(keep, 'Switch it back on')}<p style="color:#6E7F75;font-size:13px">This is the last email about it.</p>` + foot(stopUrl).html
  });
}
